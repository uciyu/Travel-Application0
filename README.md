...
自分だけの、旅行の思い出の記録ができるアプリ。家族や友達など、特定の人と共有もできる。
全国制覇を目指して、行った場所や思い出などを県ごとに記録し、行ったことのある県は、行った回数に応じてマップに色付けされていく。
...
ログイン機能
ユーザー登録機能
投稿機能（県、日付、場所（GoogleMapの住所検索による地点表示）、文章、写真）
検索機能（県、日付、場所）
自分の行ったことある場所一覧
...
グーグルのAPIで、県ごとに色付けをしたい。また、場所の検索と登録ができるようにしたい。
